...
DEFINE_string(training_file, "./data/SD/small.small.train", "Traing file name");
DEFINE_string(test_file, "./data/SD/small.small.train", "Testing file name");
DEFINE_string(dev_file, "./data/SD/small.small.train", "Dev file name");
...
int main(int argc, char *argv[]) {
    ...
    DepParseInput *parse_input_ptr = static_cast<DepParseInput *>(training_data.inputs[0]);
    std::clog << *parse_tree_ptr;
    std::clog << *parse_input_ptr;
