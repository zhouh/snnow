...
class State {
    ...
    public:
        ...
        State() {
            bGold = true; // initial state is true state
        ...
        //break;
        //actionSize++;
        //std::cout<<state->last_action<<"\t"<<tranSystem->DecodeUnlabeledAction( state->last_action )<<"+"<<tranSystem->DecodeLabel( state->last_action )<<std::endl;
