...
public:
    unsigned action_code; // each action corresponds to a integer
    ...
    Action(int action_type, int action_label){
        ...
        action_code = ActionFactory::action_label_num * action_type * action_label;
    }
...
public:
    ...
    virtual static Action* makeAction(int action_type, int action_label) {
